...
<body>
    ...
    <section class="account-form">
        <h3 class="heading">Update your account</h3>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <?php if($fetch_profile['image'] != ''){?>
                ...
                <input type="submit" name="delete_image" class="delete-btn" onclick="return confirm('Delete this image');" value="delete profile pic">
            <?php } ?>
            <div class="input-field">
